        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                ...
                <ul className="mt-4 space-y-4">
                  {loading ? (
                    ...
                    section.links.map((link) => (
                      <li key={link.slug}>
                        <Link to={`/page/${link.slug}`} className="text-base text-gray-500 hover:text-gray-900">
                          {link.title}
                        </Link>
                      </li>
                    ))
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li>
                <a href="mailto:support@mystar.co.il" className="text-base text-gray-500 hover:text-gray-900">
                  support@mystar.co.il
                </a>
              </li>
              <li>
                <a href="tel:+972-3-1234567" className="text-base text-gray-500 hover:text-gray-900">
                  03-1234567
                </a>
              </li>
            </ul>
